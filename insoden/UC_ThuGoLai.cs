...
namespace insoden
{
    public partial class UC_ThuGocLai : DevExpress.XtraEditors.XtraUserControl
    {
        List<LayTKThanhToanTheoCIF_Result> _ciftk;
        List<ThuGocLai> _inthulai;
        List<TinhThuLaiGocTheoCIF_Result> _tp;
        string _phongthu = ""; public static string _clickOnceLocation;
        public UC_ThuGocLai(List<TinhThuLaiGocTheoCIF_Result> tp, List<LayTKThanhToanTheoCIF_Result> ciftk, string phong)
        {
            _tp = tp;
            _ciftk = ciftk;
            _inthulai = new List<ThuGocLai>();
            _phongthu = phong;
            InitializeComponent();
            // This line of code is generated by Data Source Configuration Wizard
            GC_TD_Pyctl_ThuGocLai.DataSource = new System.Collections.Generic.List<insoden.ThuGocLai>();
        }
        ...
        private void GV_TD_Pyctl_ThuGocLai_CustomRowCellEdit(object sender, DevExpress.XtraGrid.Views.Grid.CustomRowCellEditEventArgs e)
        {
